...
2. If you aren't already using Yi Zhao's javascript.vim syntax, copy
   `syntax/javascript.vim` to your `~/.vim/syntax/` directory.
...
edit the `after/syntax/javascript.vim.erb` template; don't edit the generated
syntax file itself.
